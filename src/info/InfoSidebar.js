  ...
  getSidebarContent() {
    return (
      <div>
        ...
        <p>
          On the left, you can choose between the heat map and hexagon map visualization types. You can also filter
          the data via dropdowns, and select the range of time over which you want to observe aggregate trends. When you're
          done choosing your filters, hit the "apply filters" button to see the map update.
        </p>
        <p>
